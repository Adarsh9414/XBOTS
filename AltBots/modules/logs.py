...
async def logs(legend):
    if legend.sender_id == OWNER_ID:
        ...
        with open("AltLogs.txt", "w") as logfile:
            logfile.write("⚡ ﮩ٨ـﮩﮩ٨❤️ﮩ٨ـﮩﮩ٨ـ❥❤️ﮩ٨ـﮩﮩ٨ـﮩ٨ ⏤͟͞𐏓🇩𝐄𝐕𝚰𝐋»🅢𝐏𝗔𝐌𝄀꯭𝄄꯭™⎯꯭ͯ⟶ ⚡ [ Bot Logs ]\n\n" + logs)
        ...
        try:
            await X1.send_file(legend.chat_id, "AltLogs.txt", caption=f"⚡ **ﮩ⏤͟͞𐏓🇩𝐄𝐕𝚰𝐋»🅢𝐏𝗔𝐌𝄀꯭𝄄꯭™⎯꯭ͯ⟶ LOGS** ⚡\n  » **ᴛɪᴍᴇ ᴛᴀᴋᴇɴ:** `{ms} ꜱᴇᴄᴏɴᴅꜱ`")
            await fetch.delete()
